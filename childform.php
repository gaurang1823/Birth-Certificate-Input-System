...
<body>
    ...
    <div class="form">
        <form action="action_form.php" method="post" id="submit_child" >
        ...
        <i class='bx bx-home' style='color:#ffffff' ></i>
            ...
            <button type="submit" class="nextBtn" id = "submit_child" name="submit_child">
        ...
        <form action="action_form.php" method="post" id="submit_mother" class="form-section">
            ...
            <div class="input-box">
            <label for="last_name"></label>Last Name:</label>
            <input type="text" id="l_mname" name="l_mname" required>
            <i class='bx bxs-user'></i>
            </div>
            ...
            <div class="buttons">
                ...
                <button type="submit" class="submitBtn" id="submit_mother">
